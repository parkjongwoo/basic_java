...
public class BroadCastClient implements Runnable,ActionListener {
	...
	public BroadCastClient() {
		...
		fileUrlTF = new JTextField();
		sendStreamB = new JButton("전송");
		JPanel p_sendSoundFile = new JPanel();
		soundFC.showOpenDialog(null);
		fileUrlTF.setText(soundFC.getSelectedFile().getPath());
		p_sendSoundFile.add(fileUrlTF);
		p_sendSoundFile.add(sendStreamB);		
